...
export const GreenLine2Modal: React.FC<GreenLine2ModalProps> = ({
  isOpen,
  onClose,
  seatBookings,
  onBookSeat,
  ...
  const [selectedTrip, setSelectedTrip] = useState<typeof GL2_INBOUND_TRIPS[0] | null>(null);

  // Form State for Step 2
  const [selectedStoppage, setSelectedStoppage] = useState<string>('Uttara House Building');
