...
export const GL1_INBOUND_TRIPS = [
  {
    ...
    desc: 'Leaves Mirpur at 7:30 AM for morning 8:30 AM classes',
    stoppages: [
      { name: 'Mirpur', time: '07:30 AM', desc: 'Starting Point / Mirpur Terminal' },
  ...
  },
  {
    ...
    desc: 'Leaves Mirpur at 12:00 PM (Noon) for afternoon 1:00 PM classes',
    stoppages: [
      { name: 'Mirpur', time: '12:00 PM', desc: 'Starting Point / Mirpur Terminal' },
...
export const GL1_OUTBOUND_TRIPS = [
  {
    ...
    desc: 'Bus 01 departs Campus at 1:45 PM returning to Mirpur',
    stoppages: [
  ...
  },
  {
    ...
    desc: 'Bus 02 departs Campus at 4:45 PM returning to Mirpur',
    stoppages: [
  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.25rem' }}>
          <div>
            ...
            <h2 style={{ fontSize: '1.5rem', fontWeight: 800 }}>
              {selectedTrip ? `Reserve Seat on ${selectedTrip.busName}` : 'Select Bus on Green Line 1'}
            </h2>
        ...
        {/* ========================================================================= */}
        {/* STEP 1: CHOOSE WHICH OF THE 2 BUSES TO BOOK ON GREEN LINE 1 */}
        {/* ========================================================================= */}
        {!selectedTrip && (
        ...
        {/* ========================================================================= */}
        {/* STEP 2: 45-SEAT INTERACTIVE MAP & BOOKING FORM FOR CHOSEN BUS ON LINE 1 */}
        {/* ========================================================================= */}
        {selectedTrip && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
